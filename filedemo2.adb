...
procedure filedemo2 is
   ...
   -- File variable for the output file.
...
BEGIN
   ...
   -- Create the output file.  Note that this will write over any
   -- previous version of the file with the same name.
   Ada.Text_IO.Create(File=>OutputFile,
      Mode=> Ada.Text_IO.Out_File,
      Name=> "TestAverage.txt");

   -- Output the average.
   Ada.Text_Io.Put(File=>OutputFile, Item=>"Average test score is: ");
   Ada.Float_Text_Io.Put(File=>OutputFile, Item=>AverageTestScore, Fore=>0, Aft=>2, Exp=>0);
