pragma Source_File_Name (ada_main, Spec_File_Name => "b~baseball.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~baseball.adb");
...
package body ada_main is
   ...
   is
      ...
      pragma Import (Ada, Ada_Main_Program, "_ada_baseball");
