...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_maximum" & Ascii.NUL;
   ...
   u00001 : constant Version_32 := 16#e9fac723#;
   ...
   u00006 : constant Version_32 := 16#239969f1#;
   ...
   u00069 : constant Version_32 := 16#9b54df2a#;
   u00070 : constant Version_32 := 16#9a7d3fe6#;
   u00071 : constant Version_32 := 16#f78ba4a2#;
   u00072 : constant Version_32 := 16#950adbb2#;
   u00073 : constant Version_32 := 16#aa965f17#;
   u00074 : constant Version_32 := 16#5f137bb6#;
   u00075 : constant Version_32 := 16#2977527a#;
   u00076 : constant Version_32 := 16#baf4953c#;
   u00077 : constant Version_32 := 16#f9d1ee8a#;
   u00078 : constant Version_32 := 16#b90e573d#;
   u00079 : constant Version_32 := 16#0d8600cc#;
   u00080 : constant Version_32 := 16#43e3aee8#;
   u00081 : constant Version_32 := 16#05d1ef7d#;
   u00082 : constant Version_32 := 16#433e0c48#;
   u00083 : constant Version_32 := 16#e2d7b065#;
   u00084 : constant Version_32 := 16#09c28c0d#;
   u00085 : constant Version_32 := 16#5fc3f0ba#;
   u00086 : constant Version_32 := 16#4857b9e6#;
   u00087 : constant Version_32 := 16#e13c66a0#;
   u00088 : constant Version_32 := 16#27dda370#;
   u00089 : constant Version_32 := 16#4b6373ef#;
   u00090 : constant Version_32 := 16#6b0c614a#;
   u00091 : constant Version_32 := 16#b7140ae3#;
   u00092 : constant Version_32 := 16#af618d49#;
   u00093 : constant Version_32 := 16#0d25e466#;
   u00094 : constant Version_32 := 16#33d2b439#;
   u00095 : constant Version_32 := 16#f792cf9c#;
   u00096 : constant Version_32 := 16#dd2c881b#;
   u00097 : constant Version_32 := 16#834a325e#;
   u00098 : constant Version_32 := 16#0b6ed09c#;

   pragma Export (C, u00001, "maximumB");
   ...
   pragma Export (C, u00069, "ada__text_io__integer_auxB");
   pragma Export (C, u00070, "ada__text_io__integer_auxS");
   pragma Export (C, u00071, "ada__text_io__generic_auxB");
   pragma Export (C, u00072, "ada__text_io__generic_auxS");
   pragma Export (C, u00073, "system__img_biuB");
   pragma Export (C, u00074, "system__img_biuS");
   pragma Export (C, u00075, "system__img_intB");
   pragma Export (C, u00076, "system__img_intS");
   pragma Export (C, u00077, "system__img_llbB");
   pragma Export (C, u00078, "system__img_llbS");
   pragma Export (C, u00079, "system__img_lliB");
   pragma Export (C, u00080, "system__img_lliS");
   pragma Export (C, u00081, "system__img_llwB");
   pragma Export (C, u00082, "system__img_llwS");
   pragma Export (C, u00083, "system__img_wiuB");
   pragma Export (C, u00084, "system__img_wiuS");
   pragma Export (C, u00085, "system__val_intB");
   pragma Export (C, u00086, "system__val_intS");
   ...
   pragma Export (C, u00093, "system__val_lliB");
   pragma Export (C, u00094, "system__val_lliS");
